...
def load_val_dataset(args, val_dataset_name):
    ...
    if val_dataset_name == 'cifar10':
        val_dataset = CIFAR10(args.root, transform=preprocess224, download=False, train=False)

    elif val_dataset_name == 'cifar100':
        val_dataset = CIFAR100(args.root, transform=preprocess224, download=False, train=False)
        ...
        val_dataset = country211.Country211(args.root, split='test', transform=preprocess224, download=False)

    elif val_dataset_name == 'PCAM':
        val_dataset = pcam.PCAM(args.root, split='test', transform=preprocess224, download=False)
    ...
    #         val_dataset = ImageNetFolder(os.path.join(args.imagenet_root, 'train'), transform=preprocess224, select_files=eval_select)
        ...
        val_dataset = build_dataset(val_dataset_name, preprocess224, "/home/work/TPT/data", mode='test')
